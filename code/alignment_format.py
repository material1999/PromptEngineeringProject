...
def serialize_mapping_to_file(
    ...
    """
    Serialize an alignment (iterable of (source, target, relation, confidence)) to a given file.
...
def serialize_mapping_to_tmp_file(
    ...
    """
    Serialize an alignment (iterable of (source, target, relation, confidence)) to a file in the systems temp folder
...
def parse_mapping_from_string(s):
    """
    Parses an alignment from a given string.
    :param s: a string representing an alignment in alignment format
...
def parse_mapping_from_file(source):
    """
    Parses an alignment from a filename or file object.
    :param source: is a filename or file object containing an alignment in alignment format
    :return: (alignment: list of (source, target, relation, confidence), onto1 as ((id, url, formalismName, formalismURI),
    onto2 similar to onto1, extension (iterable of key, values))
    """
    handler = AlignmentHandler()
